  ...
  \begin{minipage}{0.45\textwidth}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        % Recta de CA:
        \addplot[blue, thick] coordinates {(0,12.46) (6.8,0)};
        \addlegendentry{Recta CA}
        % Punto Q
        \addplot[only marks, mark=*] coordinates {(3.39,6.23)};
        \node[above right] at (axis cs:3.39,6.23) {\emph{Q (3.39;6.23)}};

        % Líneas punteadas desde Q a los ejes
        \draw[dashed] (axis cs:3.39,6.23) -- (axis cs:3.39,0)
          node[below] {$3.39$};
        \draw[dashed] (axis cs:3.39,6.23) -- (axis cs:0,6.23)
          node[left] {$6.23$};
      \end{axis}
    \end{tikzpicture}
  \end{minipage}
