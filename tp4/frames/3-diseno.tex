...
\begin{frame}{Circuitos equivalentes}
  \begin{minipage}[t]{0.45\textwidth}
    ...
    Segun (Ec. \ref{eq:r1}) y (Ec. \ref{eq:r2}) tenemos que:
    \begin{equation*}
  ...
  \begin{minipage}[t]{0.45\textwidth}
    ...
    Segun (Ec. \ref{ec:thevenin-rb}) y (Ec. \ref{ec:thevenin-vbb}) tenemos que:
    \begin{equation*}
...
\end{frame}
\subsection{Punto Q}
\begin{frame}[allowframebreaks]{Polarizacion en CC}
...
\begin{frame}{Analisis de pequeña señal}
  \begin{figure}[ht!]
    \centering
    \resizebox{\textwidth}{!}{
        \begin{tikzpicture}
