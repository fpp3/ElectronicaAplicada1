...
\begin{aligned}
    ...
    A_v &= \frac{v_o}{v_i} = \frac{-h_{fb}\cdot i_e \cdot (R_C || R_L)}{i_e\cdot h_{ib}} 
    \approx \frac{R_C||R_L}{h_{ib}} \\[6pt]
    A_i &= \frac{i_o}{i_i} = \frac{\frac{v_o}{R_L}}{\frac{v_i}{Z_i}} 
    = \frac{v_o}{v_i}\cdot \frac{Z_i}{R_L} 
    = A_v \cdot \frac{Z_i}{R_l} \\[6pt]
    &= \frac{R_C R_L}{R_C + R_L} \cdot \frac{1}{h_{ib}} 
    \cdot \frac{R_E h_{ib}}{R_E + h_{ib}} \cdot \frac{1}{R_L} \\[6pt]
